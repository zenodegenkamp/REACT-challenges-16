...
export default function App() {
	...
	function mousedown(){
		setTorchEquipped(oldValue => !oldValue)
	}
	
	function mousedownremove(){
...
/* Challenge:
  ...
  */
	...
	return (
		<div onMouseUp={torchEquipped ?  mousedownremove: undefined}  className={`wrapper ${torchEquipped && "relative no-cursor"}`}>
			<div onMouseDown={mousedown} className={`game-area ${!torchEquipped && "relative"}`}>
